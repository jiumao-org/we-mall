...
public class DesUtil {
    ...
    /*
     * 默认的加密密匙! DES 密钥所需的字节数组长度为8位(不足8位时后面补0，超出8位只取前8位) DESede 密钥所需的字节数组长度为24位
    ...
    /**
     * 将byte数组转换为表示16进制值的字符串， 如：byte[]{8,18}转换为：0812， 和public static byte[]
    ...
    public static void main(String[] args) {
        ...
        try {
            if (strOp.equals("-de")) {
                ...
                System.out
                    .println("Wrong operater , try use \"java DesEncrypt -de|-en  'the string you want to be Encrypted'\"");
