...
public interface OauthAccessTokenDao{
	 ...
	 * @return
	 */
    int updateOauthAccessToken(@Param("enti") OauthAccessToken value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyOauthAccessToken(@Param("enti") OauthAccessToken value, @Param("assist") Assist assist);
}