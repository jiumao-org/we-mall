...
public interface OrderGoodsDao{
	 ...
	 * @return
	 */
    int updateOrderGoods(@Param("enti") OrderGoods value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyOrderGoods(@Param("enti") OrderGoods value, @Param("assist") Assist assist);
}