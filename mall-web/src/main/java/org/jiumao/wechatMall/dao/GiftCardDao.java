...
public interface GiftCardDao{
	 ...
	 * @return
	 */
    int updateGiftCard(@Param("enti") GiftCard value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyGiftCard(@Param("enti") GiftCard value, @Param("assist") Assist assist);
}