package org.jiumao.db.kafka.stream.producer;
...
import org.jiumao.db.kafka.stream.model.Order;
import org.jiumao.db.kafka.stream.serdes.GenericDeserializer;
...
public class OrderProducer {
	...
	public static void main(String[] args) throws Exception {
		...
		props.put("value.serializer", GenericDeserializer.class.getName());
		props.put("value.serializer.type", Order.class.getName());
		props.put("partitioner.class", org.jiumao.db.kafka.HashPartitioner.class.getName());
